...
extension Defaults.Keys {
  ...
  static let plainTextApps = Key<[String]>("plainTextApps", default: [], suite: preferencesSuite)
  static let expireRegexps = Key<[String]>("expireRegexps", default: [], suite: preferencesSuite)
  static let expireAfterMinutes = Key<Int>("expireAfterMinutes", default: 10, suite: preferencesSuite)
  static let detectSecrets = Key<Bool>("detectSecrets", default: true, suite: preferencesSuite)
  static let screenshotsFolderBookmark = Key<Data?>("screenshotsFolderBookmark", default: nil, suite: preferencesSuite)
